    ...
    public class UmbracoUserAppAuthenticator : ITwoFactorProvider
        {
            ...
            /// </summary>
            public const string Name = "Umbraco Two Factor Sandbox";
            ...
            public Task<object> GetSetupDataAsync(Guid userOrMemberKey, string secret)
            {
                ...
                SetupCode setupInfo = twoFactorAuthenticator.GenerateSetupCode("Umbraco Two Factor Sandbox", user.Username, secret, false);
